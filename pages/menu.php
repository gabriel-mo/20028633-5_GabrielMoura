...
<body>
  <header id="header">
    <section>
      <img src="./images/logobranca.png" width="40px" height="40px">
        <a id="logo" href="">Fast Cupcakes</a>
      </section>
      <nav id="nav">
          ...
          <ul id="menu" role="menu">
            ...
            <li><a href="./index.php?p=quemsomos">Quem Somos</a></li>
